...
class TMJob:
    ...
    def start_job(
        ...
        write_mrc(self.output_dir.joinpath(f'{self.tomo_id}_scores_mean.mrc'), results[2], self.voxel_size)
        write_mrc(self.output_dir.joinpath(f'{self.tomo_id}_scores_std.mrc'), results[3], self.voxel_size)
